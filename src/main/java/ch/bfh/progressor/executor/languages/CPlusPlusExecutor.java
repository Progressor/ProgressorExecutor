 ...
 */
public class CPlusPlusExecutor extends CodeExecutorDockerBase {
	...
	public VersionInformation fetchVersionInformation() throws ExecutorException {
		...
		String compilerOutput = this.executeSafeCommand(CodeExecutorBase.CURRENT_DIRECTORY, "g++", "--version");
