...
public class PerformanceIndicators implements org.apache.thrift.TBase<PerformanceIndicators, PerformanceIndicators._Fields>, java.io.Serializable, Cloneable, Comparable<PerformanceIndicators> {
  ...
  private static final org.apache.thrift.protocol.TField RUNTIME_MILLI_SECONDS_FIELD_DESC = new org.apache.thrift.protocol.TField("runtimeMilliSeconds", org.apache.thrift.protocol.TType.I64, (short)1);
  ...
  public long runtimeMilliSeconds; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    RUNTIME_MILLI_SECONDS((short)1, "runtimeMilliSeconds");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // RUNTIME_MILLI_SECONDS
          return RUNTIME_MILLI_SECONDS;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.RUNTIME_MILLI_SECONDS, new org.apache.thrift.meta_data.FieldMetaData("runtimeMilliSeconds", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public PerformanceIndicators setRuntimeMilliSeconds(long runtimeMilliSeconds) {
    this.runtimeMilliSeconds = runtimeMilliSeconds;
    setRuntimeMilliSecondsIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    switch (field) {
    case RUNTIME_MILLI_SECONDS:
      if (value == null) {
        unsetRuntimeMilliSeconds();
      } else {
        setRuntimeMilliSeconds((Long)value);
      }
      break;
  ...
  private static class PerformanceIndicatorsStandardScheme extends StandardScheme<PerformanceIndicators> {
        ...
        switch (schemeField.id) {
          case 1: // RUNTIME_MILLI_SECONDS
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.runtimeMilliSeconds = iprot.readI64();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PerformanceIndicators struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldBegin(RUNTIME_MILLI_SECONDS_FIELD_DESC);
      oprot.writeI64(struct.runtimeMilliSeconds);
      oprot.writeFieldEnd();
